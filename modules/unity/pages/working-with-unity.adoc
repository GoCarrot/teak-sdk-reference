...
See xref:unity-api:ROOT:class_teak_notification.adoc[TeakNotification] for more details.
...
See xref:unity-api:ROOT:class_teak_reward.adoc[TeakReward] for more details.
...
include::unity-api:ROOT:TeakNotification_ScheduleNotification_string_string_long_Reply.adoc[]
...
include::unity-api:ROOT:TeakNotification_ScheduleNotification_string_long_string()_Reply.adoc[]
...
include::unity-api:ROOT:TeakNotification_CancelScheduledNotification_string_Reply.adoc[]

=== Canceling all Local Notifications

To cancel all previously scheduled local notifications, use:

include::unity-api:ROOT:TeakNotification_CancelAllScheduledNotifications_Reply.adoc[]
...
include::unity-api:ROOT:Teak_OpenSettingsAppToThisAppsSettings.adoc[]
...
See xref:unity-api:ROOT:class_teak_post_launch_summary.adoc[TeakPostLaunchSummary] for more details.
...
include::unity-api:ROOT:Teak_SetNumericAttribute_string_double.adoc[]
...
include::unity-api:ROOT:Teak_SetStringAttribute_string_string.adoc[]
...
include::unity-api:ROOT:Teak_TrackEvent_string_string_string.adoc[]
...
include::unity-api:ROOT:Teak_IncrementEvent_string_string_string_long.adoc[]
...
include::unity-api:ROOT:Teak_RegisterRoute_string_string_string_Action(Dictionary(string_object)).adoc[]
...
include::unity-api:ROOT:Teak_ReportCanvasPurchase_string.adoc[]
